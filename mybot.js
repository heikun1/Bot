...
client.on("ready", () => {
  console.log("ExoDus Bot is Online!");
  client.user.setActivity(`-help For Help | Hei Kun#9999`);
...
client.on('message', async message => {
  ...
  let serverid = 634973817374113812;
  ...
  let isadmin = client.guilds.get("634973817374113812").members.get(message.author.id).roles.has('637603134704844820')
  ...
  if (message.channel.name == undefined) {
    ...
    if (message.channel.name == undefined) {
        ...
        client.guilds.get("513189443340075010").channels.get('513193839243034650').send(` **${message.author.username}** to **${client.user.username}**: ${message.content}`);
        } 
        else {
        client.guilds.get("513189443340075010").channels.get('513193839243034650').send(` **${message.author.username}** to **${message.channel.recipient.username}**: ${message.content}`);
        }
    }
  }
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "unmute")) {
    ...
    if (message.mentions.users.size === 1) {
      if (message.mentions.members.first().roles.has("412429266731401217")) {
         message.mentions.members.first().removeRole("412429266731401217").catch(console.error)
...
if(message.content.toLowerCase().startsWith(config.prefix + "downloadexodus")) {
      if (message.member.roles.get('636095910727909376')){
        message.reply("Check Your Dm For The Download Link!") 
    message.author.send({embed: {
        ...
        title: "After Downloading This Youre Not Allowed To Share It!",
        description: "New Update: None",
        fields: [{
        name: "Download Link:",
        value: "[Click Here!](https://cdn.discordapp.com/attachments/588605721340542976/636099172319363082/ExoDus-_Advanced.rbxl)"
          },
        ],
        timestamp: new Date(),
        footer: {
       ...
       message.reply("Youre Not WhiteListed!")
     }
   }
if(message.content.toLowerCase().startsWith(config.prefix + "downloadthreex")) {
      if (message.member.roles.get('636179708471541782')){
        message.reply("Check Your Dm For The Download Link!") 
    message.author.send({embed: {
        color: 3447003,
        author: {
        ...
        fields: [{
        name: "Download Link:",
        value: "[Click Here!](https://cdn.discordapp.com/attachments/588308953763414029/636103010434416661/ThreeX_Returned.rbxl)"
          },
        ],
        timestamp: new Date(),
        footer: {
       ...
       message.reply("You Dont Have 5 Invites!")
     }
   }
if(message.content.toLowerCase().startsWith(config.prefix + "betteraura")) {
       if (message.member.roles.get('636095910727909376')){
        message.reply("Check Your Dm For The Download Link!") 
    message.author.send({embed: {
        color: 3447003,
        ...
        title: "Better Aura Download",
        description: "After Downloading This Youre Not Allowed To Share It!",
        fields: [{
        name: "Download Link:",
        value: "[Click Here!](https://cdn.discordapp.com/attachments/595301962598318080/633176349393158162/betteraura.zip)"
          },
        ],
        timestamp: new Date(),
        footer: {
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "suggest") && suggest.current === "true") {
    ...
    if(args.length > 0) {
        message.delete(1000);
        client.guilds.get('284406338149154816').channels.get('411654579155894293').send({embed: {
    color: 3447003,
    author: {
...
message.react("426085704767111181")});
  ...
  if (message.channel.type === "dm" && message.content.startsWith(config.prefix + "testappeal")) {
...
**Appeal:** ${answer3}`)
  ...
  if (message.channel.type === "dm" && message.content.startsWith(config.prefix + "appeal")) {
    if (message.content.toLowerCase() === "back") return;
...
**Appeal:** ${answer3}`)
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "uptime")) {
    message.channel.send(`*ExoDus Bot* was last restarted **${(client.uptime / 60000).toFixed(0)} minutes** ago!`)
  }
  ...
  if(message.content.toLowerCase().startsWith(config.prefix + "loop")) {
    message.delete(1000);     
  ...
  if (message.content.startsWith("!nub")) {
   ...
   if(message.content.toLowerCase().startsWith(config.prefix + "clear")) {
      if (isadmin) {
  ...
  if(message.channel.name == undefined && message.content.toLowerCase() === "?server") {
    ...
    title: "**Here is the *ExoDus Hub* server invite!**",
  ...
  if(message.content.toLowerCase().startsWith(config.prefix + "rules")) {
    ...
    fields: [{
     ...
     {
        name: "Rule #14:",
        value: "Sharing Of Mgui Isnt allowed!"
      },
      {
        name: "Rule #15:",
  ...
  if(message.channel.name == undefined && message.content.toLowerCase() === "fun") {
   ...
   if(message.content.toLowerCase().startsWith(config.prefix + "admincommands")) {
      if (isadmin) {
	message.author.send({embed: {
	    color: 3447003,
	    author: {
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "apply") && message.channel.name === "youtube-apply") {
    ...
    let arg21 = args[20];
    message.delete(1000);
    message.reply("**you successfully applied for the YT rank!** We will get back to you soon! ExoDus Hub!");
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "yt+apply") && message.channel.name === "youtube-apply") {
    ...
    let arg21 = args[20];
    message.delete(1000);
    message.reply("**you successfully applied for the Navy Reserves (YT+) rank!** We will get back to you soon! ExoDus Hub!");
    message.guild.channels.get("637952322605023255").send(`**${message.author}** just applied for the **Navy Reserves (YT+)** rank! Channel: **${arg1}**`)
 }
  if (message.content.toLowerCase().startsWith(config.prefix + "gfxapply") && message.channel.name === "gfx-apply") {
    ...
    let arg21 = args[20];
    message.delete(1000);
    message.reply("**you successfully applied for the GFX Designer rank!** We will get back to you soon! ExoDus Hub!");
    message.guild.channels.get("637952114093719552").send(`**${message.author}** just applied for the **GFX** rank! Info: **${arg1}**`)
 }
  if (message.content.toLowerCase().startsWith(config.prefix + "help")) {
    ...
    title: "***ExoDus Hub***",
    description: "*ExoDus Commands*",
    fields: [{
        name: "__**-downloadexodus**__",
        value: "`Generates a Download to ExoDus Advanced Mgui.`"
      },
      {
        name: "__**-downloadthreex**__",
        value: "`Generates a Download to ExoDus Advanced Mgui.`"
      },
      {
        name: "__**-betteraura**__",
        value: "`Generates a Download to Better Aura.`"
      }
    ],
    timestamp: new Date(),
    footer: {
  ...
  if (message.content.toLowerCase().startsWith(config.prefix + "rule2")) {
   ...
   if (message.content.toLowerCase().startsWith(config.prefix + "ytadd" && isadmin)) {
    ...
    let arg3 = args[2];
    message.delete(1000);
    message.guild.channels.get("634973817374113812").send(`${arg1}, **You have been accepted, congrats on recieving the National Guard (YT) rank! :thumbsup:**`)
   ...
   if (message.content.toLowerCase().startsWith(config.prefix + "yt+add" && isadmin)) {
    ...
    let arg3 = args[2];
    message.delete(1000);
    message.guild.channels.get("634973817374113812").send(`${arg1}, **You have been accepted, congrats on recieving the Navy Reserves (YT+) rank! :thumbsup:**`)
   ...
   if (message.content.toLowerCase().startsWith(config.prefix + "gfxadd" && isadmin)) {
    ...
    let arg3 = args[2];
    message.delete(1000);
    message.guild.channels.get("634973817374113812").send(`${arg1}, **You have been accepted, congrats on recieving the Presidential Designer rank! :thumbsup:**`)
    let role = message.guild.roles.find("name", "Presidential Designers");
    let member = message.mentions.members.first();
    member.addRole(role).catch(console.error);
   }
   if (message.content.toLowerCase().startsWith(config.prefix + "WhiteList") && message.author.id === config.ownerID) {
    let arg1 = args[0];
    let arg2 = args[1];
    let arg3 = args[2];
    message.delete(1000);
